      ...
      actions={
        (selectedCategory || selectedMonth) && (
          ...
          >
            ...
            Limpar Filtros
            {selectedCategory && <span className="ml-1.5 font-bold">({selectedCategory})</span>}
            {selectedMonth && <span className="ml-1.5 font-bold">[{selectedMonth}]</span>}
          </Button>
        )
      }
    >
      {/* KPIs Grid - Increased gap for space & breathability */}
            ...
            >
              ...
              <CardContent className="pt-2">
                <div className="font-mono text-[26px] font-bold tracking-tight text-white mt-1">
                  <AnimatedCounter value={k.value} formatter={brl} />
                </div>
